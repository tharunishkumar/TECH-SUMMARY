...
#llama_parse_documents = LlamaParse(api_key='llx-BI4JpJZMAngtIzR2t6bLs6bS6CsG1R8FenjqjaBDjonTqAX4', result_type="markdown").load_data("./data/ALZHEIMERS-Understanding-the-disease.pdf")
...
def load_or_parse_data():
    ...
    if os.path.exists(data_file):
        ...
        llama_parse_documents = LlamaParse(api_key='llx-BI4JpJZMAngtIzR2t6bLs6bS6CsG1R8FenjqjaBDjonTqAX4', result_type="markdown").load_data("./data/ALZHEIMERS-Understanding-the-disease.pdf")
        #llama_parse_documents = LlamaParse(api_key=llamaparse_api_key, result_type="markdown").load_data(["llamaparser-example\data\ALZHEIMERS-Understanding-the-disease.pdf"])
...
qdrant_url = os.getenv("https://7cea8a27-df7f-4898-b073-8edaf0943b22.us-east4-0.gcp.cloud.qdrant.io")
qdrant_api_key = os.getenv("mjDvpWWaPG0bhEM2TFd9jfDZxl2WiQV4Zwd2nNGPmSIKqUBckbpcTg")
...
groq_api_key = os.getenv("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")

llm = Groq(model="mixtral-8x7b-32768", api_key='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')
...
client = qdrant_client.QdrantClient(api_key='mjDvpWWaPG0bhEM2TFd9jfDZxl2WiQV4Zwd2nNGPmSIKqUBckbpcTg', url="https://7cea8a27-df7f-4898-b073-8edaf0943b22.us-east4-0.gcp.cloud.qdrant.io",)

vector_store = QdrantVectorStore(client=client, collection_name='llama')
